...
{- Define aquí las variables que necesites. -}
...
expr1 = {- Aquí va su expresión -}
sol1 = {- Aquí va el código para decidir si el argumento es correcto. -}
...
expr2 = {- Aquí va su expresión -}
sol2 = {- Aquí va el código pars decidir si el argumento es correcto. -}
